...
export default async function ScoremasterGamePage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="max-w-md mx-auto space-y-6">
      <Link href="/scoremaster" className="text-[var(--muted)] hover:text-[var(--foreground)] text-base font-medium transition-colors">
        ← Games
      </Link>
      ...
      <GameScoreForm game={game as any} returnPath="/scoremaster" />
    </div>
  );
}
